...
export const ProtectedLayout = (page: React.ReactElement): JSX.Element => {
    // const isLoggedIn = useSelector(authSelector.getLoggedInSelector())

    // if (!isLoggedIn) return <SiteLayout>Sorry, you don&lsquo;t have access</SiteLayout>
