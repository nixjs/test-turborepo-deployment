...
export const CurrencySingleValue: React.FC<SingleValueProps<PaymentTypes.Currency>> = (props) => {
    const {
...
export const CurrencyOption: React.FC<OptionProps<PaymentTypes.Currency>> = (props) => {
    const {
        data: { displayName, symbol }
    } = props
    const symbolPath = `/tokens/ic24px_${symbol.toLowerCase() || 'none'}.svg`
