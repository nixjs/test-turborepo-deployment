...
import { onInitGameConfig } from 'modules/game/limbo/redux/game/slice'
import { SoundSources } from 'modules/game/limbo/consts/consts'
import { BetStateProvider } from 'modules/game/limbo/context/BetContext'
import { SoundProvider } from 'modules/game/limbo/context/SoundContext'
...
export const Board: React.FC<BoardPropArg> = () => {
    ...
    useJoinGame(GameSymbol.GS_LIMBO, 'GameSymbol.GS_LIMBO')
